...
(
    ...
    `u_date` date    NOT NULL COMMENT 'Last Update Time'
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
(
    `b_ID`    varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
    `b_Name`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'Name',
    `b_PSWD`  varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'password',
    `b_email` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'email',
...
-- ----------------------------
INSERT INTO `banker`
VALUES ("60782293981", "admin", "admin", "admin@bu.edu");
...
VALUES ("670820845", "1234323445920849", "House2", 5000.0, 0);
INSERT INTO `collateral`
VALUES ("670820845", "1244592024524849", "Car3", 50000.0, 0);
...
VALUES ("Apple", "USD", 100.0);
INSERT INTO `stockInfo`
VALUES ("KWEICHOW MOUTAI ", "CNY", 2000.0);
INSERT INTO `stockInfo`
VALUES ("TOKYO ELECTRON", "JPY", 48320.0);
